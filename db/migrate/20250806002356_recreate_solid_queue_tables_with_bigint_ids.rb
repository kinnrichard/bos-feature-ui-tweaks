class RecreateSolidQueueTablesWithBigintIds < ActiveRecord::Migration[8.0]
  def up
    # Drop all SolidQueue tables (they should be empty or have test data only)
    ...
    # Recreate them with explicit bigint IDs (override app's UUID default)
  ...
  def down
    raise ActiveRecord::IrreversibleMigration, "This migration drops and recreates tables. Create a new migration to revert if needed."
  end
end
